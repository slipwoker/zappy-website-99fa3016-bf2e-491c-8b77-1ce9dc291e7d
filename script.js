    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Shabos uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '99fa3016-bf2e-491c-8b77-1ce9dc291e7d',
                    name: data.name || '',
                    email: data.email || '',
